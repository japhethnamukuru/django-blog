...
def post_list(request, tag_slug=None):
    ...
    return render(request, 'content/index.html', {'page':page, 'posts':posts, 'tag':tag}) 
...
def post_share(request, post_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'japhethnamukuru@gmail.com', [cd['to']])
            sent = True        
    else:
        form = EmailPostForm()

    return render(request, 'content/share.html', {'post':post, 'form':form, 'sent':sent})
